...
insert into mud.beings (name, description, room, owner) values ($1, $2, $3, $4) returning id, name, description, room, owner
`
...
func (q *Queries) CreateBeing(ctx context.Context, arg *CreateBeingParams) (MudBeing, error) {
	row := q.queryRow(ctx, q.createBeingStmt, createBeing,
		arg.Name,
		arg.Description,
		arg.Room,
		arg.Owner,
